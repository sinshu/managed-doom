...
namespace ManagedDoomTest.CompatibilityTests
{
    ...
    public class Monsters
    {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\barrel_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\zombieman_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\zombieman_test2.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\shotgunguy_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\chaingunguy_test.wad"))
            {
        ...
        public void ImpTest()
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\imp_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\demon_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\lostsoul_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\cacodemon_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\baron_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\revenant_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\fatso_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\arachnotron_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\painelemental_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\archvile_test.wad"))
            {
        ...
        {
            using (var resource = GameData.CreateDummy(WadPath.Doom2, @"data\telefrag_test.wad"))
            {
