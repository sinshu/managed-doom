    ...
    public class ThingTest
    {
        ...
        public void LoadE1M1()
        {
            using (var wad = new Wad(WadPath.Doom1))
            {
                ...
                var things = Thing.FromWad(wad, map + 1);
                ...
                Assert.AreEqual(90, things[0].Facing.ToDegree(), delta);
                Assert.AreEqual(1, (int)things[0].Type);
                ...
                Assert.AreEqual(180, things[57].Facing.ToDegree(), delta);
                Assert.AreEqual(2015, (int)things[57].Type);
                ...
                Assert.AreEqual(90, things[142].Facing.ToDegree(), delta);
                Assert.AreEqual(2001, (int)things[142].Type);
        ...
        public void LoadMap01()
        {
            using (var wad = new Wad(WadPath.Doom2))
            {
                ...
                Assert.AreEqual(270, things[57].Facing.ToDegree(), delta);
                Assert.AreEqual(2006, (int)things[57].Type);
                ...
                Assert.AreEqual(0, things[68].Facing.ToDegree(), delta);
                Assert.AreEqual(2005, (int)things[68].Type);
